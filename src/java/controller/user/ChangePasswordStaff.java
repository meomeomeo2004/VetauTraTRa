...
@WebServlet(name = "ChangePasswordStaff", urlPatterns = {"/change-staff-password"})
public class ChangePasswordStaff extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("changeStaffPassword.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!userDAO.checkOldPassword(staffId, oldPassword)) {
                ...
                boolean isUpdated = userDAO.changePasswordUser(staffId, newPassword);
                if (isUpdated) {
                    message = "Password changed successfully!";
                    session.removeAttribute("account");
                    response.sendRedirect("/tratra/staff/login");
                    return;
                } else {
        ...
        response.sendRedirect("change-staff-password");
    }
}
