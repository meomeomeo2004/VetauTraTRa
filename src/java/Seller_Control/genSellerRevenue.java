 ...
 */
@WebServlet(name = "genSellerRevenue", urlPatterns = {"/genSellerRevenue"})
public class genSellerRevenue extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet genSellerRevenue</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet genSellerRevenue at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<SellerRevenue> sere = dao.getSellerRevenue(duration, acc.getId());
        ...
        for (SellerRevenue d : sere) {
            LocalDateTime d_ldt = d.getDate().toLocalDate().atStartOfDay();
            if (d_ldt.isAfter(oneDurationAgo.minusNanos(1))) {
                ...
                revenueByEach.set((int) m, revenueByEach.get((int) m) + (int) d.getAmount_paid());
            }
        }
        ...
        if (duration.equalsIgnoreCase("month")) {
            ...
            for (int i = 0; i < durationLabels.length; i++) {
                ...
                data.add(revenueByEach.get(durationValues));
                durationValues++;
            }
        }
