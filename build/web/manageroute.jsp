        ...
        <div class="main-content">
            ...
            <main class="content">
                ...
                <c:if test="${not empty editerror}">
                    <div class="alert custom-alert shadow-sm border-start border-danger border-4 rounded-3 p-3 mb-4" id="existAlert">
                        <div class="d-flex align-items-center">
                            <div class="alert-icon me-3">
                                <i class="fas fa-exclamation-circle text-danger fs-4"></i>
                            </div>
                            <div class="flex-grow-1">
                                <h5 class="fw-bold mb-1 text-danger">Warning</h5>
                                <p class="mb-0 text-secondary">${editerror}</p>
                            </div>
                            <button type="button" class="btn-close" onclick="document.getElementById('existAlert').remove()" aria-label="Close"></button>
                        </div>
                    </div>
                </c:if>

                <!-- Success Alert for 'dif' variable (Green) -->
                    ...
                    <div class="alert custom-alert shadow-sm border-start border-success border-4 rounded-3 p-3 mb-4" id="difAlert">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="mb-0 text-secondary">${deletesuc}</p>
                            </div>
                ...
                <c:if test="${not empty update}">
                    <div class="alert custom-alert shadow-sm border-start border-success border-4 rounded-3 p-3 mb-4" id="difAlert">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="fw-bold mb-1 text-success">Success</h5>
                                <p class="mb-0 text-secondary">${update}</p>
                            </div>
                            <button type="button" class="btn-close" onclick="document.getElementById('difAlert').remove()" aria-label="Close"></button>
                        </div>
                    </div>
                ...
                <c:if test="${not empty updatestatus}">
                    <div class="alert custom-alert shadow-sm border-start border-success border-4 rounded-3 p-3 mb-4" id="difAlert">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="fw-bold mb-1 text-success">Success</h5>
                                <p class="mb-0 text-secondary">${updatestatus}</p>
                            </div>
                            <button type="button" class="btn-close" onclick="document.getElementById('difAlert').remove()" aria-label="Close"></button>
                        </div>
                    </div>
                </c:if>
                <c:if test="${not empty addsuces}">
                    <div class="alert custom-alert shadow-sm border-start border-success border-4 rounded-3 p-3 mb-4" id="difAlert">
                        <div class="d-flex align-items-center">
                            <div class="alert-icon me-3">
                                <i class="fas fa-check-circle text-success fs-4"></i>
                            ...
                            <div class="flex-grow-1">
                                <h5 class="fw-bold mb-1 text-success">Success</h5>
                                <p class="mb-0 text-secondary">${addsuces}</p>
                            </div>
                            <button type="button" class="btn-close" onclick="document.getElementById('difAlert').remove()" aria-label="Close"></button>
                        </div>
                    </div>
