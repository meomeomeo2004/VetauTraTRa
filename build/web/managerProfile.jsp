                            ...
                            <div class="profile-nav-card">
                                ...
                                <ul class="profile-nav-list">
                                    <li class="profile-nav-item">
                                        <a href="manager-profile" class="profile-nav-link active">
                                            <i class="fas fa-user"></i> View Profile
                                        </a>
                                    </li>
                                    <li class="profile-nav-item">
                                        <a href="update-manager-profile" class="profile-nav-link">
                            ...
                            <div class="content-card border">
                                ...
                                <div class="profile-info">
                                    ...
                                    <div class="profile-details">
                                        ...
                                        <a href="update-manager-profile" class="btn-edit">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " value="${manager.fullName}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" value="${manager.phoneNumber}" disabled>
                                    </div></div>
                                ...
                                <div class="form-group">
                                    <label class="form-label">Address</label><div class="input-group">
                                        ...
                                        <input type="email" class="form-control" value="${manager.address}" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
