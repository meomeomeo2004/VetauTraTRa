...
<head>
  ...
  <title>Cập nhật Chuyến Tàu</title>
  ...
  <div class="main-content">
      ...
      <div class="content">
          <div class="form-container">
              <h3>Cập nhật Chuyến Tàu</h3>
              <!-- Giả sử đối tượng chuyến tàu cần cập nhật được gán cho "r" -->
              <form action="updateroute" method="POST">
                  ...
                  <div class="row mb-3">
                      ...
                      <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="routecode" name="routecode" placeholder="Nhập mã chuyến đi" value="${r.routecode}">
                      </div>
                  </div>
                  <div class="row mb-3">
                      <div class="col-md-12">
                          <label for="description" class="form-label">Nội Dung Mô Tả</label>
                          <textarea class="form-control" id="description" name="description" rows="3" placeholder="Nhập nội dung mô tả">${r.describe}</textarea>
                      </div>
                  </div>
                  <div class="row mb-3">
                      <div class="col-md-6">
                          <label for="departureDateTime" class="form-label">Ngày & Giờ Đi</label>
                          <!-- Đảm bảo giá trị của departureDateTime được format đúng định dạng datetime-local -->
                          <input type="datetime-local" class="form-control" id="departureDateTime" name="departureDateTime" value="${r.departureTime}">
                      </div>
                      <div class="col-md-6">
                          <label for="returnDateTime" class="form-label">Ngày & Giờ Về</label>
                          <input type="datetime-local" class="form-control" id="returnDateTime" name="returnDateTime" value="${r.arrivalTime}">
                      </div>
                  </div>
                  <div class="row mb-3">
                      <div class="col-md-6">
                  ...
                  <div class="d-flex justify-content-end">
                      <button type="submit" class="btn btn-success me-2" onclick="return confirm('Bạn xác nhận thay đổi thông tin chuyến tàu của bạn?');">Cập nhật</button>
                      <a href="viewlistroute" class="btn btn-danger">Hủy</a>
                  </div>
              </form>
          </div>
      </div>
